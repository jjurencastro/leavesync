...
elseif (in_array($request_uri, ['/views/login.html', '/views/activate.html', '/views/verify_device.html', '/views/dashboard.html', '/views/new_request.html', '/views/settings.html', '/views/my_requests.html', '/views/admin.html'])) {
