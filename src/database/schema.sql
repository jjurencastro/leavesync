...
-- Configurable policy, permission, and escalation controls.
...
-- WebAuthn passkeys, used to approve leave/device-change requests (manager/hr/admin roles only)
...
-- Short-lived WebAuthn challenges, tied to a specific approval context to prevent replay
