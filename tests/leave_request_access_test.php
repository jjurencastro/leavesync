...
$pendingRequest = ['user_id' => 10, 'requester_supervisor_id' => 20, 'assigned_supervisor_id' => 20, 'supervisor_status' => 'pending', 'status' => 'pending'];
$hrReadyRequest = ['user_id' => 10, 'requester_supervisor_id' => 20, 'assigned_supervisor_id' => 30, 'supervisor_status' => 'approved', 'status' => 'pending'];
$hrAssignedRequest = ['user_id' => 10, 'assigned_supervisor_id' => 30, 'supervisor_status' => 'pending', 'status' => 'pending'];
$supervisorRejectedRequest = ['user_id' => 10, 'assigned_supervisor_id' => 20, 'supervisor_status' => 'rejected', 'status' => 'rejected'];
...
assertAccess(LeaveRequestAccess::canView($supervisorRejectedRequest, ['id' => 30, 'role' => 'hr']), true, 'HR should access terminal supervisor rejections for recordkeeping');
